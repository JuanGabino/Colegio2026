   					...
   					<div class="row">
   	 				...
   	 				<div class="row">
   	 					<div class="col-md-6" id="divBuscarObservaciones">
   	 						...
   	 						<div class="col-md-6">
   	 							<button  type="submit" id="btnDescargar" name="btnDescargar" class="btn btn-danger"><img src="../../Imagenes/descarga.ico"   height="20" width="20">
   	 								Descargar Observaciones</button>
   	 						</div>
                        </div>
   	 				</div><br><br>
   	 				</form>
